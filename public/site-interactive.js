/**
 * AlternaVest Capital — The Sovereign Ledger
        ...
        '<div class="av-modal-card">',
          ...
          '<form id="investor-form" class="av-form-grid" novalidate>',
            ...
            '<div class="av-field">',
              ...
              '<input id="investor-phone" name="phone" type="tel" placeholder="+91 98765 43210" required autocomplete="tel" />',
            '</div>',
            '<div class="av-field">',
          ...
          '<form id="consultation-form" class="av-consultation-form" novalidate>',
            '<div class="av-consultation-top-grid">',
              ...
              '<div class="av-field">',
                ...
                '<input id="consultation-phone" name="phone" type="tel" placeholder="+91 98765 43210" required autocomplete="tel" />',
              '</div>',
            '</div>',
            ...
            '<label class="av-consent">',
              ...
              '<span>I hereby give my consent to receive calls, WhatsApp messages, SMS and e-mails from AlternaVest Capital regarding my investment consultation.</span>',
            '</label>',
